...
export class ItineraireController {
     ...
     */
    static async FindAllItineraire(req:Request,res:Response){
        try {
 ...
 */
    static async FindItineraireById(req:Request,res:Response){
        try {
     ...
     */
    static async CreateItineraire(req:Request,res:Response){
        try {
     ...
     */
    static async UpdateItineraire(req:Request,res:Response){
        try {
            const id =  Number(req.params.id);
     ...
     */
    static async RemoveItineraire(req:Request,res:Response){
        try {
            const id =  Number(req.params.id);
