...
export class ProvinceController{
     ...
     */
    static async getProvinceById(req:Request,res:Response){
        try {
     ...
     */
    static async createProvince(req:Request,res:Response){
        try {
     ...
     */
    static async removeProvince(req:Request,res:Response){
        try {
            const id = Number(req.params.id);
